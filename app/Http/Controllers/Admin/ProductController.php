...
class ProductController extends Controller
{
    ...
    public function NoProductImage(Request $request, $id) {
    ...
    public function UpdateProductImage(Request $request, $id) {
      ...
      $image_three = $request->image_three;
        ...
        if($image_one){
            ...
            $notification=array(
                'messege'=>'First Image Updated Successfully',
                'alert-type'=>'success'
                 );
               return Redirect()->route('all.product')->with($notification);
    }
        if($image_two){
            ...
            $product = DB::table('products')->where('id', $id)->update($data);
            $notification=array(
                'messege'=>'Second Image Updated Successfully',
                'alert-type'=>'success'
                 );
               return Redirect()->route('all.product')->with($notification);
    }
        if($image_three){
            ...
            $product = DB::table('products')->where('id', $id)->update($data);
            $notification=array(
                'messege'=>'Third Image Updated Successfully',
                'alert-type'=>'success'
                 );
               return Redirect()->route('all.product')->with($notification);
    }
