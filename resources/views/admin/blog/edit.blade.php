...
@endphp
 ...
 <div class="sl-mainpanel">
  <nav class="breadcrumb sl-breadcrumb">
    <a class="breadcrumb-item" href="index.html">MyddleShop</a>
    <span class="breadcrumb-item active">Update Post</span>
  </nav>

  <div class="sl-pagebody">

  <div class="card pd-20 pd-sm-40"><h6> Update Post
        <a href="{{ route('all.blogpost')}}" class="btn btn-success btn-sm pull-right"> All Product</a>
      </h6>
    ...
    @csrf
      ...
      <div class="form-layout">
        <div class="row mg-b-25">
          ...
          <div class="col-lg-6">
            <div class="form-group">
              <label class="form-control-label">Post Title (DEUTCH): <span class="tx-danger">*</span></label>
              <input class="form-control" type="text" name="post_title_de"  value="{{ $post->post_title_de }}">
            </div>
          </div><!-- col-4 -->
        ...
        <textarea class="form-control" id="summernote"  name="details_en"> 
         ...
         {!! $post->details_en !!}
           ...
           <div class="col-lg-12">
            <div class="form-group">
              <label class="form-control-label">Product Details (DEUTCH): <span class="tx-danger">*</span></label>

            <textarea class="form-control" id="summernote1"  name="details_de"> 
                {!! $post->details_de !!}
            </textarea>
