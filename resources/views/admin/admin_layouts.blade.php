...
<html lang="en">
  <head>
    ...
    <title>MyddleShop Ecommerce Site </title>
  ...
  <body>
    ...
    @else
      <!-- ########## START: LEFT PANEL ########## -->
        <div class="sl-logo">
         <a href=""><i class="icon ion-android-star-outline"></i> MyddleShop</a></div>
         ...
         $(document).on("click", "#delete", function(e){
             ...
             var link = $(this).attr("href");
                swal({
                  ...
                  text: "Once Deleted, This data will be Permanently Wiped!",
                  icon: "warning",
                  buttons: true,
                  dangerMode: true,
                })
