		...
		<div class="top_bar">
			<div class="container">
				<div class="row">
                    ...
                    <div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ asset('public/front/images/phone.png')}}" alt=""></div>+233 505 7841 56</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ asset('public/front/images/mail.png')}}" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo_container">
							<div class="logo"><img src="{{ asset('public/frontend/images/logo.jpg')}}" alt=""></div>
						</div>
					</div>
...
<script src="{{ asset('public/frontend/plugins/greensock/TimelineMax.min.j')}}s"></script>
...
<script src="https://use.fontawesome.com/9fcc9c58d2.js"></script>
